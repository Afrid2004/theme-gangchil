<?php
    $catname_7 = ot_get_option('7_category'); //changeable
    if (empty($catname_7)) {
        $catname_7 = 1667; //changeable
    }
    
query_posts(array(
    'cat'               =>  $catname_7, //changeable
    'posts_per_page'    =>  1,
    'order'             =>  'DESC'
));?>
...
<div class="category">
    <h2> 
        <a href="<?php echo get_category_link($catname_7); ?>">
            <?php echo get_cat_name($catname_7);?>
        </a> 
    </h2>
