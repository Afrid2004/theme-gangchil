<?php
    $catname_11 = ot_get_option('11_category'); //changeable
    if (empty($catname_11)) {
        $catname_11 = 1667; //changeable
    }
    query_posts(array(
        'cat'               =>  $catname_11, //changeable
        'posts_per_page'    =>  1,
        'order'             =>  'DESC'
));?>
...
<div class="per_category category">
  <h2> 
    <a href="<?php echo get_category_link($catname_11); ?>">
        <?php echo get_cat_name($catname_11);?>
    </a> 
</h2>
