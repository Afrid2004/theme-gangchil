...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      array(
        'id'          => 'breaking_on_of',
        'title'       => __( 'ব্রেকিং অন/অফ', 'theme-text-domain' )
      ),array(
        'id'          => 'theme_color',
        'title'       => __( 'থিমের কালার', 'theme-text-domain' )
      ),array(
        'id'          => 'menu_active_color',
        'title'       => __( 'মেনুর একটিভ কালার', 'theme-text-domain' )
      ),array(
        'id'          => 'menu_font__color',
        'title'       => __( 'মেনু ও ক্যাটাগরি নামের লেখার কালার', 'theme-text-domain' )
      ),array(
        'id'          => 'menu_ul_li_right_border',
        'title'       => __( 'মেনুর ডান পাশের বর্ডারের কালার', 'theme-text-domain' )
      ),array(
        'id'          => 'menu_ul_li_left_border',
        'title'       => __( 'মেনুর বাম পাশের বর্ডারের কালার', 'theme-text-domain' )
      ),array(
        'id'          => 'footer_color',
        'title'       => __( 'নিচের পুটার কালার', 'theme-text-domain' )
      ),array(
        'id'          => 'main_logo',
        'title'       => __( 'মূল লোগো', 'theme-text-domain' )
      ),
	  array(
        'id'          => 'top_ad',
        'title'       => __( 'মূল লোগোর ডান পাশের বিজ্ঞাপন', 'theme-text-domain' )
      ),
	  array(
        'id'          => 'home_page_ad',
        'title'       => __( 'হোম পেইজের বাম পাশের সকল বিজ্ঞাপন', 'theme-text-domain' )
      ),
	  array(
	  ...
	  array(
        'id'          => 'right_advertisement',
        'title'       => __( 'হোম পেইজের ডান পাশের বিজ্ঞাপনগুলো', 'theme-text-domain' )
      )
    ),
    'settings'        => array( 
	  array(
		'id'			=>	'theme_color_id',
		'label'			=>	__('থিমের কালার পরিবর্তন করতে পারবেন এখান থেকে...', 'theme-text-domain'),
        'std'           => '#a52a2a',
        'type'          =>  'colorpicker',
        'section'		=>	'theme_color'  
        ),
        array(
		'id'			=>	'breaking_on_of_id',
		'label'			=>	__('থিমের কালার পরিবর্তন করতে পারবেন এখান থেকে...', 'theme-text-domain'),
        'std'           => 'off',
        'type'          =>  'on-off',
        'section'		=>	'breaking_on_of'  
        ),
        array(
		'id'			=>	'menu_active_color_id',
		'label'			=>	__('মেনুর একটিভ কালার নির্বাচন করুন এখান থেকে', 'theme-text-domain'),
        'std'           => '#5a1112',
        'type'          =>  'colorpicker',
        'section'		=>	'menu_active_color'  
        ),
        array(
        ...
        'std'           => '#5a1112',
        'type'          =>  'colorpicker',
        'section'		=>	'menu_ul_li_right_border'  
        ),
        array(
        ...
        'std'           => '#d13636',
        'type'          =>  'colorpicker',
        'section'		=>	'menu_ul_li_left_border'  
        ),
        array(
		'id'			=>	'footer_color_id',
		'label'			=>	__('নিচে পুটার কালার পরিবর্তন করতে পারবেন এখান থেকে...', 'theme-text-domain'),
        'std'           => '#faebd7',
        'type'          =>  'colorpicker',
        'section'		=>	'footer_color'  
        ),array(
		'id'			=>	'website_main_logo',
		'label'			=>	__('এই ওয়েবসাইটের মূল লোগো আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('মূল লোগোর পরিমাপ-  প্রস্থ ২৮৯ পিক্সেল, দৈর্ঘ্য ৯১ পিক্সেল')),	
		'type'			=>	'upload',
		'section'		=>	'main_logo'
	  ),
	  array(
		'id'			=>	'website_top_ad_google_adsense',
		'label'			=>	__('মূল লোগোর ডান পাশের বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('মূল লোগোর ডান পাশের বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করতে পারবেন এখান থেক')),	
		'type'			=>	'text',
		'section'		=>	'top_ad'
	  ),
	  array(
		'id'			=>	'website_top_ad',
		'label'			=>	__('মূল লোগোর ডান পাশের বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ৭৫০ পিক্সেল, দৈর্ঘ্য ১১৪ পিক্সেল')),	
		'type'			=>	'upload',
		'section'		=>	'top_ad'
	  ),
	  array(
		'id'			=>	'website_top_ad_link',
		'label'			=>	__('মূল লোগোর ডান পাশের বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
	  ...
	  array(
		...
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ৭২৫ পিক্সেল, দৈর্ঘ্য ১০০ পিক্সেল')),	
		'type'			=>	'upload',
		'section'		=>	'home_page_ad'
	  ),
	  array(
	  ...
	  array(
		'id'			=>	'right_top_google_adsense',
		'label'			=>	__('ক্যাটাগরি ও সিঙ্গেল পেইজের ডানপাশের উপরের বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'category_single_page_right_top'
	  ),
	  array(
		'id'			=>	'website_category_single_page_right_top',
		'label'			=>	__('ক্যাটাগরি ও সিঙ্গেল পেইজের ডানপাশের উপরের বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'category_single_page_right_top'
	  ),
	  array(
		'id'			=>	'website_category_single_page_right_top_link',
		'label'			=>	__('ক্যাটাগরি ও সিঙ্গেল পেইজের ডানপাশের উপরের বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'category_single_page_right_top'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_1',
		'label'			=>	__('1_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_1',
		'label'			=>	__('1_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_1',
		'label'			=>	__('1_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_2',
		'label'			=>	__('2_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_2',
		'label'			=>	__('2_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_2',
		'label'			=>	__('2_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_3',
		'label'			=>	__('3_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_3',
		'label'			=>	__('3_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_3',
		'label'			=>	__('3_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_4',
		'label'			=>	__('4_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_4',
		'label'			=>	__('4_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_4',
		'label'			=>	__('4_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_5',
		'label'			=>	__('5_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_5',
		'label'			=>	__('5_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_5',
		'label'			=>	__('5_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_6',
		'label'			=>	__('6_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_6',
		'label'			=>	__('6_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_6',
		'label'			=>	__('6_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_7',
		'label'			=>	__('7_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_7',
		'label'			=>	__('7_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_7',
		'label'			=>	__('7_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_8',
		'label'			=>	__('8_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_8',
		'label'			=>	__('8_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_8',
		'label'			=>	__('8_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_9',
		'label'			=>	__('9_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_9',
		'label'			=>	__('9_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_9',
		'label'			=>	__('9_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_10',
		'label'			=>	__('10_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_10',
		'label'			=>	__('10_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_10',
		'label'			=>	__('10_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),       
     ...
     // no_11
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_11',
		'label'			=>	__('11_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_11',
		'label'			=>	__('11_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_11',
		'label'			=>	__('11_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),  
     ...
     // no_12
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_12',
		'label'			=>	__('12_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_12',
		'label'			=>	__('12_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_12',
		'label'			=>	__('12_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ), 
     ...
     // no_13
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_13',
		'label'			=>	__('13_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_13',
		'label'			=>	__('13_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_13',
		'label'			=>	__('13_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
     ...
     // no_14
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_14',
		'label'			=>	__('14_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_14',
		'label'			=>	__('14_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_14',
		'label'			=>	__('14_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ), 
     ...
     // no_15
	  ...
	  array(
		'id'			=>	'right_advertisement_google_adsense_15',
		'label'			=>	__('15_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের গুগল অ্যাডসেন্সের কোড পেস্ট করুন এখানে...', 'theme-text-domain'),
		'desc'			=>	sprintf(__('গুগল অ্যাডসেন্সের কোড এখানে পেস্ট করুন...')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_15',
		'label'			=>	__('15_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপন আপলোড করতে পারবেন এখান থেকে', 'theme-text-domain'),
		'desc'			=>	sprintf(__('পরিমাপ-  প্রস্থ ২৫০ পিক্সেল, দৈর্ঘ্য ১৫০ পিক্সেল বা তার চেয়েও বেশি')),	
		'type'			=>	'upload',
		'section'		=>	'right_advertisement'
	  ),
	  array(
		'id'			=>	'right_advertisement_link_15',
		'label'			=>	__('15_ডানপাশের বিজ্ঞাপন (ভিডি সেকশনের নিচ থেকে) বিজ্ঞাপনের লিংক দিন এখানে (যদি থাকে)', 'theme-text-domain'),
		'desc'			=>	sprintf(__('যেমন-https://www.example.com')),	
		'type'			=>	'text',
		'section'		=>	'right_advertisement'
	  ),  
