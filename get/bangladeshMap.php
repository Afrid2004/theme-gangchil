...
<div class="homePageSideSvg">
	<div class="fix title_name_no_link">
        <h6 class="header_bg_1 text-white px-3 py-1"> সকল বিভাগের খবর </h6>
    </div>
...
<style type="text/css">
    ...
    <g id="rangpur">
        <a href="<?php echo get_site_url(); ?>/category/রংপুর/" xlink:href="<?php echo get_site_url(); ?>/category/রংপুর/">
...
QmCC" transform="matrix(0.7972 0 0 0.7972 -116.5603 -268.4205)">
    ...
    <g id="sylhet">
        <a href="<?php echo site_url(); ?>/category/সিলেট" xlink:href="<?php echo site_url(); ?>/category/সিলেট">
...
xM63OXPU7+FbyjXxYbf5StyWUP9/fYdf/xBgAC9n6lG6sC1xAAAAAElFTkSuQmCC" transform="matrix(0.8485 0 0 0.8485 198.1667 -130.2727)">
    ...
    <g id="khulna">
        <a href="<?php echo site_url(); ?>/category/খুলনা" xlink:href="<?php echo site_url(); ?>/category/খুলনা">
...
oiMrnXhTGsZ3JpLOqicJ/j/eneNPAQYAqlIjWQakbmIAAAAASUVORK5CYII=" transform="matrix(0.9259 0 0 0.9259 -78.6667 95.6296)">
    ...
    <g id="dhaka">
        <a href="<?php echo site_url(); ?>/category/ঢাকা" xlink:href="<?php echo site_url(); ?>/category/ঢাকা">
...
AAAAADgafgowAC4wT/jUaBZlAAAAAElFTkSuQmCC" transform="matrix(1 0 0 1 38 -86)">
    ...
    <g id="mymensingh">
        <a href="<?php echo site_url(); ?>/category/ময়মনসিংহ" xlink:href="<?php echo site_url(); ?>/category/ময়মনসিংহ">
...
1fX6+q8AAwAexfCEjBB1ggAAAABJRU5ErkJggg==" transform="matrix(1.0957 0 0 1.0957 -3 -165.3478)">
    ...
    <g id="rajshahi">
        <a href="<?php echo site_url(); ?>/category/রাজশাহী" xlink:href="<?php echo site_url(); ?>/category/রাজশাহী">
...
zXvxONlKAAAAAElFTkSuQmCC" transform="matrix(0.8673 0 0 0.8673 -141.6667 -127)">
    ...
    <g id="borishal">
        <a href="<?php echo site_url(); ?>/category/বরিশাল" xlink:href="<?php echo site_url(); ?>/category/বরিশাল">
...
pNtZrT3uLWr4tnf+FmAA6KLD8jcePaIAAAAASUVORK5CYII=" transform="matrix(1.1322 0 0 1.1322 34.7654 163.216)">
    ...
    <g id="chittagong">
        <a href="<?php echo site_url();?>/category/চট্টগ্রাম" xlink:href="<?php echo site_url();?>/category/চট্টগ্রাম">
