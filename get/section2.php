              ...
              <div class="carousel-inner">
                <div class="imageBox position-relative">
                  <a href="<?php the_permalink(); ?>">
                    ...
                    <?php } else { ?>
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/542x348px.jpg' ?>"
                      alt="<?php the_title(); ?>">
                    <?php } ?>
                ...
                <a href="<?php the_permalink(); ?>">
                  <div class="col-12 mb-2 px-0">
                    <div class="imageBox position-relative">
                      ...
                      <?php } else { ?>
                      <img src="<?php echo get_template_directory_uri() . '/assets/images/272x148px.jpg' ?>"
                        alt="<?php the_title(); ?>">
                      <?php } ?>
                      <h6 class="position-absolute bottom-0 bg-tf text-white text-center p-2 w-100 mb-0">
                        <?php the_title(); ?> </h6>
                    </div>
                  </div>
                </a>
